<template>
    <div class="flex flex-col items-center flex-1">
        <!-- Banner -->
        <div v-if="route.query.preview" class="text-white bg-color-secondary w-full p-4 text-center">
        ...
        <div class="flex flex-col items-center text-white py-12">
            ...
            <p class="text-sm mb-12">{{
                    new Date(weatherData.currentTime).toLocaleTimeString('en-US', dateFormat)
            }}
            </p>
